          ...
          <div className="flex  md:flex-row flex-col justify-center items-center lg:gap-64 md:gap-10">
            ...
            <div className="md:flex flex-col text-left mt-2 hidden">
              ...
              <a
                ...
                className="bg-[#D9D9D9] text-[17px] rounded-[4px] mt-8 pt-[3px] w-[110px] h-[35px] font-poppins text-[#000000] hover:scale-104 hidden md:block text-center mt-2"
              >
                <button>
                  Live Demo
                </button>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#D9D9D9] md:hidden block text-[17px] rounded-[4px] mt-8 pt-[3px] w-[110px] h-[35px] font-poppins text-[#000000] hover:scale-104 text-center mt-2"
            >
              <button>
                Live Demo
              </button>
